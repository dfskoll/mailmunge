...
Mailmunge ships with six Docker files for creating containers that do
regression tests.  The six files are for the six combinations of
(Sendmail, Postfix) as the MTA, and (Debian 11, Debian 10, Rocky Linux
8) as the Linux distribution.
