...
my $ctx = parse_and_copy_msg($msg_dir, 't/data/generic-msg', 'addpart');
...
ok(results_has_lines($msg_dir, 'C', 'F'),
   'Got expected lines in RESULTS');
like(`cat $msg_dir/RESULTS`, qr/Mmultipart\/mixed;%20boundary=%22/,
     "Content type was changed to multipart/mixed");
like(`cat $msg_dir/NEWBODY`, qr|<html><head><title>Foo</title></head><body><p>Wookie</p></body></html>|, 'New entity was added');
