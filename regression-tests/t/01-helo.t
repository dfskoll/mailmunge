...
$ans = smtp_send($ip, 'tempfail', 'user1@example.com', ['user1@example.com'], $msg);
...
cmp_deeply($ans, {
           code => 451,
           dsn => '4.3.0',
           txt => 'I tempfail your HELO',
           stage => 'mail'}, 'Got expected tempfail at mail stage');


$ans = smtp_send($ip, 'reject', 'user1@example.com', ['user1@example.com'], $msg);
cmp_deeply($ans, {
           code => 554,
           dsn => '5.7.1',
           txt => 'I reject your HELO',
           stage => 'mail'}, 'Got expected reject at mail stage');

$ans = smtp_send($ip, 'continue', 'user1@example.com', ['user1@example.com'], $msg);
cmp_deeply($ans, {
           code => 200,
           dsn => '2.0.0',
           txt => 'OK',
